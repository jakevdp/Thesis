...
In order to constrain parameters in
...
constraints on the slope $H_0$ of the Hubble relation.  All of these have
...
tighter constraint from the WMAP 7-year analysis, $H_0 = 70.4 \pm 2.5$
km/s/Mpc.
...
\comment{Mention work with the supernova collaboration \citep{Kessler2009},
