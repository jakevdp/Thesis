...
def calcpow(rhoin,dx1,dx2=None,Nl=100):
    if numpy.any(numpy.iscomplex(rhoin)):
        return calcpow_complex(rhoin,dx1,dx2=None,Nl=100)
    else:
        return calcpow_scalar(rhoin,dx1,dx2=None,Nl=100)

def calcpow_complex(gammain,dx1,dx2=None,Nl=100):
    """
    ...
    g1 = fftpack.fft2(gammain.real)
    g2 = fftpack.fft2(gammain.imag)
...
def calcpow_EB_ratio(gammain,dx1,dx2=None,Nl=100):
    """
    compute the power spectrum of the 2D array gammain (real or complex)
    dx1 and dx2 give the pixel size in arcmin
    """
...
def calcpow_scalar(rhoin,dx1,dx2=None,Nl=100):
    """
